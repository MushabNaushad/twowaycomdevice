...
class commlink_radio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.transport_n5 = transport.transport_layer(m, rto_ms, "responder", mtu)
        self.transport_n4 = transport.transport_layer(m, rto_ms, "responder", mtu)
        self.transport_n3 = transport.transport_layer(m, rto_ms, "responder", mtu)
        self.transport_n2 = transport.transport_layer(m, rto_ms, "responder", mtu)
        self.transport_n1 = transport.transport_layer(m, rto_ms, "initiator", mtu)
