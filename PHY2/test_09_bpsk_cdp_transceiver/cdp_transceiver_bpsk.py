...
# Title: PHY2 Test 09: CDP BPSK Transceiver
# Author: mushab404
# Description: PHY2 Stage 09: Complete Modular CDP BPSK Transceiver
...
class cdp_transceiver_bpsk(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "PHY2 Test 09: CDP BPSK Transceiver", catch_exceptions=True)
        ...
        self.adpt_alg = adpt_alg = digital.adaptive_algorithm_cma( BPSK_CONST, .0001, 1).base()
...
def main(top_block_cls=cdp_transceiver_bpsk, options=None):
    tb = top_block_cls()
