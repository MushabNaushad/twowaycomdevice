...
class bpsk_linear_equalizer(gr.top_block):
    ...
    def __init__(self):
        ...
        self.adpt_alg = adpt_alg = digital.adaptive_algorithm_cma( BPSK_CONST, .001, 1).base()
...
def main(top_block_cls=bpsk_linear_equalizer, options=None):
    tb = top_block_cls()
