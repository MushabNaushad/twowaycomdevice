...
# Title: PHY2 Universal Multi-Hardware Transceiver
# Author: mushab404
# Description: PHY2 Universal Multi-Hardware BPSK Transceiver (Pluto, BladeRF, RTL-SDR)
...
class cdp_transceiver_multi_hardware(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PHY2 Universal Multi-Hardware Transceiver", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PHY2 Universal Multi-Hardware Transceiver")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "cdp_transceiver_multi_hardware")
        ...
        2, 2, 2, 1, 1).base()
        self.ADDR_PLUTO = ADDR_PLUTO = "ip:192.168.2.1"
        ...
        self._ADDR_PLUTO_tool_bar.addWidget(Qt.QLabel("Pluto URI" + ": "))
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32(ADDR_PLUTO if ADDR_PLUTO else iio.get_pluto_uri(), [True, True], 32768)
...
def main(top_block_cls=cdp_transceiver_multi_hardware, options=None):
