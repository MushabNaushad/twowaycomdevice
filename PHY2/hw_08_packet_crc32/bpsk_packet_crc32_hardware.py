...
# Title: PHY2 Test 08: BPSK Packet CRC32 Hardware
# Author: mushab404
# Description: PHY2 Stage 08: BPSK Packet Engine & CRC32 with SDR Hardware
...
class bpsk_packet_crc32_hardware(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PHY2 Test 08: BPSK Packet CRC32 Hardware", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PHY2 Test 08: BPSK Packet CRC32 Hardware")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "bpsk_packet_crc32_hardware")
...
def main(top_block_cls=bpsk_packet_crc32_hardware, options=None):
