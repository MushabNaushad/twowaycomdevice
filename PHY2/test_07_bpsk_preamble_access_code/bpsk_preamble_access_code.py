...
# Title: PHY2 Test 07: BPSK Preamble & Access Code
# Author: mushab404
# Description: PHY2 Stage 07: BPSK with Preamble and Access Code Frame Synchronization
...
class bpsk_preamble_access_code(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "PHY2 Test 07: BPSK Preamble & Access Code", catch_exceptions=True)
        ...
        self.channels_channel_model_0 = channels.channel_model(
            ...
            noise_seed=0,
            block_tags=False)
        self.blocks_vector_source_x_0 = blocks.vector_source_b([0x55]*16 + [0xE1, 0x5A, 0xE8, 0x93] + [0x48, 0x65, 0x6C, 0x6C, 0x6F] + [0x00]*16, False, 1, [])
...
def main(top_block_cls=bpsk_preamble_access_code, options=None):
    tb = top_block_cls()
