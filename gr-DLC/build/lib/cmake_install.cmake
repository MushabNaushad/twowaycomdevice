...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  foreach(file
      ...
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib64/libgnuradio-DLC.so.1.0.0"
      )
    if(EXISTS "${file}" AND
       NOT IS_SYMLINK "${file}")
      file(RPATH_CHECK
  ...
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib64/cmake/gnuradio-DLC/gnuradio-DLCTargets.cmake")
    ...
    if(_cmake_export_file_changed)
      ...
      if(_cmake_old_config_files)
        ...
        message(STATUS "Old export file \"$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib64/cmake/gnuradio-DLC/gnuradio-DLCTargets.cmake\" will be replaced.  Removing files [${_cmake_old_config_files_text}].")
