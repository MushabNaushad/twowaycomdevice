...
class test_transport(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.msg_connect((self.DLC_deStuffing_0, 'out'), (self.transport_transport_layer_1, 'pdu_in'))
        ...
        self.msg_connect((self.transport_transport_layer_0, 'pdu_out'), (self.DLC_bitStuffing_0, 'in'))
