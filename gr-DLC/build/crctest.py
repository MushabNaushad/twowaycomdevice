...
class crctest(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "CRC test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CRC test")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "crctest")
        ...
        self.blocks_message_debug_0_0_0_0 = blocks.message_debug(True, gr.log_levels.info)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.DLC_CRCCheck_0, 'out'), (self.blocks_message_debug_0_0_0, 'print'))
        ...
        self.msg_connect((self.pdu_random_pdu_0, 'pdus'), (self.blocks_message_debug_0_0_0_0, 'print'))
...
def main(top_block_cls=crctest, options=None):
