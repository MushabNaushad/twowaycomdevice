...
class transeciever(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fll_loop_bw = fll_loop_bw = 0.0200
        self.costas_bw = costas_bw = 0.0300
        ...
        self.connect((self.digital_crc32_bb_0, 0), (self.blocks_unpack_k_bits_bb_1, 0))
