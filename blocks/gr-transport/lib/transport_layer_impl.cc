...
namespace gr {
  namespace transport {
    ...
    void
    transport_layer_impl::forecast (int noutput_items, gr_vector_int &ninput_items_required)
    {
    ...
    int
    transport_layer_impl::general_work (int noutput_items,
