...
<<<<<<< HEAD
        self.packets = packets = 100
=======
        self.payload_size = payload_size = 64
<<<<<<< HEAD
        self.packets = packets = 300
>>>>>>> 7ecdd35bf8a03786faad8b1a9e1e7c1eb7e79633
=======
        self.packets = packets = 100
>>>>>>> parent of 7ecdd35 (Working ANT-ANT)
...
<<<<<<< HEAD
        ...
        self.qtgui_eye_sink_x_1.set_y_label('Amplitude', "after symbol sync")
        ...
        self.qtgui_eye_sink_x_0.set_y_label('Amplitude', "after FLL")
...
<<<<<<< HEAD
        ...
        self.connect((self.digital_fll_band_edge_cc_0, 0), (self.qtgui_eye_sink_x_0, 0))
        self.connect((self.digital_fll_band_edge_cc_0, 0), (self.qtgui_freq_sink_x_3, 0))
        ...
        self.connect((self.digital_symbol_sync_xx_0, 0), (self.qtgui_eye_sink_x_1, 0))
        self.connect((self.iio_pluto_source_0, 0), (self.blocks_copy_1_1, 0))
        self.connect((self.iio_pluto_source_0, 0), (self.qtgui_freq_sink_x_2, 0))
